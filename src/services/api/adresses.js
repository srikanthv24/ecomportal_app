...
export class Adresses {
  static getAddressList = async (id) => {
    return await fetch('https://m76jgm5mv5a5ta56kwht6e6ipm.appsync-api.us-east-1.amazonaws.com/graphql', {
      ...
      body: JSON.stringify({
        query:`{
          listAddresses (filter: {customer_id: {eq: "578461ea-bc50-4d40-8c0a-5c4546abc2d7"}}) {
          items {   
          customer_name
          aline1
          aline2
  ...
  static postAddress = (data) => {
    ...
    return fetch('https://m76jgm5mv5a5ta56kwht6e6ipm.appsync-api.us-east-1.amazonaws.com/graphql', {
        method: 'post',
        headers: {
            'Content-Type': 'application/json',
            "X-API-KEY": "da2-j7yxgxymtrarzavgivfwda4h5u",
