export const SERVICE_TYPE = {
  ...
  PAUSE_IN_BETWEEN: "PAUSE_IN_BETWEEN",
  PAUSE_INDEFINITE: "PAUSE_INDEFINITE",
...
export const SESSION_ERROR_MSG = "Choose meal session";
export const MEALPLAN_SELECTION_ERROR_MSG = "Choose meal plan";
