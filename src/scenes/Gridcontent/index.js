  ...
  return (
    <>
      <div className="d-flex overflow-hidden grid-content-1">        
        ...
        <div className="relative bg-koromiko text-center md:w-1/2 step2-info">
          ...
          <div className="d-flex justify-content-between">
            <img src={BananaLeavesImage} alt="banana leaves" className="bananaleaves-img"  />
      ...
      <div className="d-flex overflow-hidden">        
        <div className="relative minh-700 text-center md:w-1">
