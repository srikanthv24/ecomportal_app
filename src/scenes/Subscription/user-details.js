...
import { getGender, getDietPreference, getPhysicalActivity, getGoalList, saveUserData} from '../../store/actions/customer';


export default function UserDetails({handleBack, handleNextStep, activeStep}) {
  ...
  useEffect(() => {
    ...
    customerValues && Object.keys(customerValues.goalList).length && 
    ...
    customerValues && Object.keys(customerValues.dietList).length && 
    ...
    customerValues && Object.keys(customerValues.genderList).length && 
      ...
      let temp4 = [];
      customerValues && Object.keys(customerValues.activityList).length && 
          ...
          <Form className="m-3">
            ...
            < Select
              ...
              <FloatingLabel
                ...
                className="mt-3"
                 >
                  <Form.Control type="text" value={userData.weight}  onChange={(e) => handleDataChange("weight", e.target.value)}/>
              </FloatingLabel>
              ...
              <FloatingLabel
                ...
                className="mt-3"
                 >
                <Form.Control type="text" value={userData.height} onChange={(e) => handleDataChange("height", e.target.value)}/>
              </FloatingLabel>          
          </Form>
        </Col>
        <Col xs={12} sm={12} md={6} lg={6} className="d-flex mt-2">
        <Button disabled={activeStep === 0} onClick={handleBack} className="w-50 m-1" variant="secondary">
                Back
          </Button>
